#
# Be sure to run `pod spec lint MokiManageSDK.podspec' to ensure this is a
...
s.license      = {
  ...
  # s.authors      = { "MokiMobility" => "info@mokimobility.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'MokiMobility', 'other author'
  ...
  #
  #s.public_header_files = 'MokiManage.h'
